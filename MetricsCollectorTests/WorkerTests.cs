...
namespace MetricsCollectorTests
{
    public class WorkerTests : TempDirectory
    {
        ...
        public async Task TestScraping()
        {
            ...
            /* test */
            Worker worker = new Worker(scraper.Object, storage.Object, uploader.Object, BaseDelay, TimeSpan.FromDays(1));

            CancellationTokenSource cts = new CancellationTokenSource();
            var workerTask = worker.Start(cts.Token);
        ...
        public async Task TestUploading()
        {
            ...
            /* test */
            Worker worker = new Worker(scraper.Object, storage.Object, uploader.Object, TimeSpan.FromDays(1), BaseDelay);
